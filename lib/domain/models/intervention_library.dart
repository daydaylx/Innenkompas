  ...
  static const Intervention regulation4_6Breathing = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        helpText:
            'Schreibe ein paar Worte darüber, was sich verändert hat.',
      ),
    ],
  ...
  static const Intervention groundingExercise = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        body:
            'Schau dich um und nenne 5 Dinge, die du gerade sehen kannst.',
      ...
      InterventionStep(
        ...
        body:
            'Höre genau hin. Nenne 3 Geräusche, die du gerade wahrnimmst.',
  ...
  static const Intervention impulsePause = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        title: 'T - Tief atmen',
        body:
            'Nimm 3 tiefe Atemzüge. Atme langsam ein und langsam aus.',
  ...
  static const Intervention factCheck = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        body:
            'Welcher automatische Gedanke ist dir gekommen?',
        helpText:
      ...
      InterventionStep(
        ...
        body:
            'Wie könntest du die Situation jetzt realistischer sehen?',
        helpText:
  ...
  static const Intervention ruminationStop = Intervention(
    ...
    steps: [
      InterventionStep(
        ...
        subtitle: 'Dauer: ca. 3-5 Minuten',
        helpText:
            'Grübeln kostet Energie und verschlimmert oft die Stimmung.',
      ),
      InterventionStep(
        id: 'detect',
        type: InterventionStepType.action,
      ...
      InterventionStep(
        ...
        body:
            'Wähle eine Tätigkeit, die deine Aufmerksamkeit erfordert:',
        options: [
          'Spazieren gehen',
          'Musik hören',
...
4. Mache einen konkreten Vorschlag''',
      ...
      InterventionStep(
        ...
        body:
            'Was ist objektiv passiert? Beschreibe ohne Bewertung.',
        helpText:
            'Statt "Du hast geschrien" → "Du hast laut gesprochen"',
      ),
      InterventionStep(
        id: 'feeling',
        type: InterventionStepType.reflection,
      ...
      InterventionStep(
        ...
        body:
            'Setze deine Ich-Botschaft zusammen:',
        helpText:
      ...
      InterventionStep(
        ...
        body:
            'Wann möchtest du das Gespräch führen?',
        options: [
          'Jetzt sofort',
          'In einer Stunde',
          'Heute Abend',
  ...
  static const Intervention overwhelmStructure = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        helpText:
            'Wenn du dich unsicher bist, kommt es meist in Kategorie 2.',
      ),
      InterventionStep(
        id: 'select_one',
        type: InterventionStepType.action,
        ...
        body:
            'Wähle EINE Sache aus der "MACH ICH JETZT"-Liste aus. Nur eine.',
        helpText:
      ...
      InterventionStep(
        ...
        body:
            'Zerlege diese eine Aufgabe in die kleinstmöglichen Schritte.',
        helpText:
            'Statt "Küche aufräumen" → "Spüler ausräumen" (5 Minuten).',
      ),
      InterventionStep(
        id: 'first_step',
        type: InterventionStepType.action,
        ...
        body:
            'Was ist der allerkleinste Schritt, den du jetzt tun kannst?',
        helpText:
            'Dieser Schritt sollte weniger als 2 Minuten dauern.',
      ),
      InterventionStep(
        id: 'timer',
  ...
  static const Intervention selfValueCheck = Intervention(
    ...
    steps: [
      ...
      InterventionStep(
        ...
        title: 'Bemerken',
        body:
            'Wann kritisiert du dich gerade? Welche Worte benutzt du?',
        helpText:
            'Hör auf deinen inneren Kritiker. Was sagt er?',
      ),
      InterventionStep(
      ...
      InterventionStep(
        ...
        body:
            'Formuliere 3 freundliche Sätze, die du dir selbst sagen kannst:',
      ...
      InterventionStep(
        ...
        body:
            'Lege eine Hand auf dein Herz. Spüre die Wärme.',
        durationSec: 30,
        helpText:
  ...
  static const Intervention acuteRegulation = Intervention(
    ...
    steps: [
      InterventionStep(
        ...
        subtitle: 'Dauer: ca. 2-3 Minuten',
        helpText:
            'Du bist in Sicherheit. Atmen. Du schaffst das.',
      ),
      InterventionStep(
        id: 'ground',
        type: InterventionStepType.action,
        ...
        helpText:
            'Drücke deine Füße aktiv in den Boden. Spüre die Stabilität.',
      ),
      InterventionStep(
        id: 'breathe',
        type: InterventionStepType.breathing,
      ...
      InterventionStep(
        ...
        helpText:
            'Wiederhole dies mehrmals für dich selbst.',
      ),
      InterventionStep(
        id: 'next_step',
        type: InterventionStepType.selection,
  ...
  static List<Intervention> getRecommended({
    ...
    if (preferredTypes != null && preferredTypes.isNotEmpty) {
      final preferred = interventions
          .where((i) => preferredTypes.contains(i.type))
          .toList();
      final others = interventions
          .where((i) => !preferredTypes.contains(i.type))
          .toList();
  ...
  /// Alle Kategorien
  static List<String> get categories => allInterventions
      .map((i) => i.category ?? 'Sonstige')
      .toSet()
      .toList()
    ..sort();
